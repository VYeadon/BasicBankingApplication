...
public class DepositWindow
{
	...
	public void createDepositWindow()
	{
		...
		window = new JFrame("Bank: Deposit Money ");
		...
		createDepositWindowObjects();
		
		window.setSize(400,400);
		window.setVisible(true);
	}
	
	public void createDepositWindowObjects()
	{
		...
		enterRequest.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				try 
				{
					...
					{
						new BankSQLConnection(Integer.parseInt(accountField.getText()), Integer.parseInt(amountField.getText()), 2, balanceField);
					}
					else
					{
